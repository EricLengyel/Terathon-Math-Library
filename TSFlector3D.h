...
namespace Terathon
{
	...
	///
	/// The \c Flector3D class encapsulates a 3D reflection operator (flector).
	...
	class Flector3D
	{
		public:
			...
			/// by the \c offset parameter and a reflection through the plane given by the \c plane parameter.
			...
			/// @param plane	The unitized reflection plane.
			///
			/// The \c MakeRotoreflection() function returns a flector representing a rotation through the angle
			/// given by the \c angle parameter about the line given by the \c axis parameter and a reflection
			/// across the plane given by the \c plane parameter.
			...
			///
			/// The \c GetTransformMatrix() function converts a flector to the Transform3D object that
			...
			///
			/// The \c GetInverseTransformMatrix() function converts a flector to the inverse of the Transform3D object that
			...
			///
			/// The \c GetTransformMatrices() function converts a flector to the Transform3D object that represents the same
	...
	/// @brief Returns the negation of the 3D flector \c F.
	/// @related Flector3D
	...
	/// @brief Returns the product of the 3D flector \c F and the scalar \c n.
	/// @related Flector3D
	...
	/// @brief Returns the product of the 3D flector \c F and the inverse of the scalar \c n.
	/// @related Flector3D
	...
	/// @brief Returns a boolean value indicating whether the two 3D flectors \c a and \c b are equal.
	/// @related Flector3D
	...
	/// @brief Returns a boolean value indicating whether the two 3D flectors \c a and \c b are not equal.
	/// @related Flector3D
	...
	/// @brief Returns the geometric antiproduct of the 3D flectors \c a and \c b.
	/// @relatedalso Flector3D

	TERATHON_API Motor3D operator *(const Flector3D& a, const Flector3D& b);

	/// @brief Returns the geometric antiproduct of the 3D flector \c a and the 3D motor \c b.
	/// @relatedalso Flector3D

	TERATHON_API Flector3D operator *(const Flector3D& a, const Motor3D& b);

	/// @brief Returns the geometric antiproduct of the 3D motor \c a and the 3D flector \c b.
	/// @relatedalso Flector3D
	...
	/// @brief Transforms the 3D vector \c v with the flector \c F.
	/// @relatedalso Flector3D

	TERATHON_API Vector3D Transform(const Vector3D& v, const Flector3D& F);

	/// @brief Transforms the 3D flat point \c q with the flector \c F.
	/// @relatedalso Flector3D

	TERATHON_API FlatPoint3D Transform(const FlatPoint3D& q, const Flector3D& F);

	/// @brief Transforms the 3D Euclidean point \c q with the flector \c F.
	/// @relatedalso Flector3D

	TERATHON_API Point3D Transform(const Point3D& q, const Flector3D& F);

	/// @brief Transforms the 3D line \c l with the flector \c F.
	/// @relatedalso Flector3D

	TERATHON_API Line3D Transform(const Line3D& l, const Flector3D& F);

	/// @brief Transforms the 3D plane \c h with the flector \c F.
	/// @relatedalso Flector3D

	TERATHON_API Plane3D Transform(const Plane3D& h, const Flector3D& F);

	/// @brief Transforms the 3D bivector \c v with the flector \c F.
	/// @relatedalso Flector3D
	...
	/// @brief Returns the reverse of the 3D flector \c F.
	/// @relatedalso Flector3D
	...
	/// @brief Returns the antireverse of the 3D flector \c F.
	/// @relatedalso Flector3D
	...
	/// @brief Returns the squared bulk norm of the 3D flector \c F.
	/// @relatedalso Flector3D
	...
	/// @brief Returns the squared weight norm of the 3D flector \c F.
	/// @relatedalso Flector3D
